...
@section('content')
    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-9 mx-auto">
                        ...
                        <ul class="list-inline widget-list-inline">
                                ...
                                <li class="list-inline-item"><a href="#">thanhf phoos</a></li>
        ...
        <!-- end of ba  nner -->
        @include('layouts.patior.phobien')

        <section class="section-sm">
            <div class="container">
                <div class="row justify-content-center">
                    @include('layouts.patior.resentPost')
                    @include('layouts.patior.aside')
                </div>
            </div>
        </section>
    </div>
    <div class="instafeed text-center mb-5">
        ...
        <div class="instagram-slider">
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/1.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/2.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/4.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/3.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/2.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/1.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/3.jpg"></div>
            <div class="instagram-post"><img src="theme/clients/reader/images/instagram/4.jpg"></div>
